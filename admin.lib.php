...
// 모바일 스킨경로를 얻는다
function get_mobile_skin_dir($skin, $len='')
{
    global $g4;
...
function help($help="", $left=0, $top=0)
{
	...
	$s = "<a href='#none' title='".$help."' class='tooltip_link center'><img src='$g4[admin_path]/img/icon_help.gif' border=0 width=15 height=15 align=absmiddle></a>";
	return $s;
...
if (get_session("ss_mb_key") !== $admin_key) {
    ...
    include_once("$g4[path_pc]/lib/mailer.lib.php");
    // 메일 알림
